var YOUR_CLIENT_ID = '837943993291-ockna05iiitrqkjjldcun1h623pheo2n.apps.googleusercontent.com';
  ...
  if (Object.keys(params).length > 0) {
    ...
    if (params['state'] && params['state'] == 'singIn_state') {
      singIn();
    }
  }
      ...
      xhr.send(null);
        ...
        function SignOut() {
            ...
            auth2.signOut().then(function () {
                ...
                document.getElementById(singIn()).innerHTML = 'LOGIN';
                document.getElementById(singIn()).onclick = oauth2SignIn();
    });
    }
